...
// ============================================================
// Camp Biblique-Navs 2026 — Layout public (Phase 4, Étape A)
...
const classeLien = (actif: boolean) =>
  `px-3 py-2 text-sm font-medium rounded-lg transition-colors duration-200 ${
    actif ? 'bg-[#E7F2DE] text-[#1B3B1A]' : 'text-gray-500 hover:text-[#1B3B1A]'
  }`
...
export default function PublicLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F9F0]">
      {/* Bannière d'information (ex : redirection depuis l'espace comité) */}
      {messageVisible && messageAcces && (
        <div className="bg-[#D9A441]/15 border-b border-[#D9A441] px-4 py-2.5 flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="text-[#8A6A23] text-sm font-semibold shrink-0"
          >
            ✕
          </button>
        </div>
      ...
      {/* Navigation mobile : menu bas + "Plus" */}
